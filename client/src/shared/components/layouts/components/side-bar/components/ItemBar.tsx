    ...
    <>
     {
       (!subRoutes || subRoutes.length < 1)?(
         <Link href={path} className={`py-4 px-6 font-semiBold rounded-md hover:bg-gray-50 ${isActive ? 'font-bold text-primary bg-gradient-to-r from-indigo-100 via-white to-white' : ''}`}>
           <Center>
